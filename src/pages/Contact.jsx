            ...
            <div className='w-full md:w-2/3 lg:w-1/2 flex items-center container p-5 mx-auto min-h-screen my-auto'>
                <div className='w-full'>
                    <div className="flex justify-between items-center pb-8">
                        <h1 className='text-5xl text-center md:lg:text-left'>Contact me 👋🏻</h1>
                        {formState === 'sent' ?
                            <div className='bg-emerald-400 text-emerald-900 border-emerald-900 border-2 py-5 px-7 text-lg rounded-lg'>Sent succesfully</div>
                            :
                            formState === 'error' ?
                                <div className='bg-rose-400 text-rose-900 border-rose-900 border-2 py-5 px-7 text-lg rounded-lg'>Error occured</div>
                                :
                                ''
                        }
                    </div>
                    <form action="" className='flex flex-col gap-3 border-2 border-primary-900 p-10 rounded-3xl w-full' onSubmit={handleSubmit}>
                        ...
                        <input ref={nameRef} className='h-8 px-4 py-5 outline-offset-0 rounded-md focus:outline-2  focus:outline-primary-900' type="text" />
